...
question_expansion_prompt = PromptTemplate(
    ...
    template=(
        ...
        "CURRENT DATE: {current_year}-{current_month}-{current_day}\n\n"
        "EXAMPLES:\n"
        "Conversation: User asked 'Who is the current US president?' / Answer: 'Donald Trump'\n"
        "User question: 'Who is his VP?'\n"
        "→ Who is Donald Trump's vice president?\n\n"
        "Conversation: User asked 'How much do bananas cost?' / Answer: '$2 per pound'\n"
        "User question: 'Where can I buy them?'\n"
        "→ Where can I buy bananas?\n\n"
        "Conversation: User asked 'Tell me about Tesla Model 3' / Answer: 'Electric sedan...'\n"
