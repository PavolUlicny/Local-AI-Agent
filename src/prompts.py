...
planning_prompt = PromptTemplate(
    ...
    template=(
        ...
        "YOUR TASK:\n"
        "FIRST: Check if Results found so far + Known answers already contain enough information to fully answer the User question.\n"
        "- If YES (question can be fully answered): Output NONE and stop.\n"
        "- If NO (more information needed): Create NEW search queries to find the missing information.\n\n"
        "CRITICAL: ONLY suggest queries if you genuinely need MORE information to answer the question.\n"
